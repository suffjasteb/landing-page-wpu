<x-layout>
  ...
  <div class="py-4 px-4 mx-auto max-w-screen-xl lg:px-6">
    <div class="mx-auto max-w-screen-md sm:text-center">
        <form action="/belajar-laravel/public/posts" action="GET">
            ...
            {{-- jika ada request ke author ubah nama nya jadi nama author request nya author --}}
            @if (request('author'))
...
@forelse ( $posts as $post )
              ...
              <article class="p-6 px-4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                  <div class="flex justify-between items-center mb-5 text-gray-500">
                     <a href="/belajar-laravel/public/posts?category={{ $post->category->slug }}">
                        {{-- kalo warna ga di coba dulu gabisa anjir --}}
                  ...
                  <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white hover:underline"><a href="{{ url('/posts/' . $post['slug']) }}">{{ $post->title }}</a></h2>
                  ...
                  <div class="flex justify-between items-center">
                      <div class="flex items-center space-x-3">
                          ...
                          <a href="/belajar-laravel/public/posts?author={{ $post->author->username }}">
                            <span class="font-medium text-xs dark:text-white">
                              {{ $post->author->name }}
                              </span>
                          </a>
                      </div>
                      <a href="{{ url('/posts/' . $post['slug']) }}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                          Read more
      ...
      @empty
          ...
          <a href="/belajar-laravel/public/posts" class="text-blue-500 hover:underline">&laquo; Back to all Posts</a>
          </div>
    @endforelse
</div>  
</div>
